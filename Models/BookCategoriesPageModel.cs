...
namespace Pustan_Radu_Lab2_bun.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Pustan_Radu_Lab2_bunContext context, Book book)
        {
        ...
        public void UpdateBookCategories(Pustan_Radu_Lab2_bunContext context, string[] selectedCategories, Book bookToUpdate)
        {
